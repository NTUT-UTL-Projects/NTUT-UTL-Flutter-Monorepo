...
class HexKeyboardTheme extends ThemeExtension<HexKeyboardTheme> {
  ...
  HexKeyboardTheme copyWith({
    ...
    Color? submitColor,
        ...
        submitColor: clearColor ?? this.submitColor,
      );

  @override
  HexKeyboardTheme lerp(ThemeExtension<HexKeyboardTheme>? other, double t) {
    if (other is! HexKeyboardTheme) return this;
    return HexKeyboardTheme(
      backspaceColor: Color.lerp(
          backspaceColor as Color?,
          other.backspaceColor as Color?,
          t,
        ) ??
        backspaceColor,
      clearColor: Color.lerp(
          clearColor as Color?,
          other.clearColor as Color?,
          t,
        ) ??
        clearColor,
      submitColor: Color.lerp(
          submitColor as Color?,
          other.submitColor as Color?,
          t,
        ) ??
        submitColor,
    );
