...
class MockSeatCushionSensor implements SeatCushionSensor {
  final StreamController<LeftSeatCushion> _leftController = StreamController.broadcast();

  final StreamController<RightSeatCushion> _rightController = StreamController.broadcast();
